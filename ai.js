...
[ข้อมูลสรุปการเงินปัจจุบัน] (ใช้ตอบเมื่อผู้ใช้ถามถึงยอดรวม/ภาพรวม)
- ยอดรวมสุทธิของวันนี้ (ร้าน+บ้าน): รายรับรวม ${todayIncome} บ. | รายจ่ายรวม ${todayExpense} บ. | กำไรสุทธิวันนี้ ${todayIncome - todayExpense} บ.
- บัญชีร้านค้าวันนี้: รายรับ ${todayStoreIncome} บ. | รายจ่าย ${todayStoreExpense} บ. | คงเหลือ ${todayStoreIncome - todayStoreExpense} บ.
- บัญชีครัวเรือนวันนี้: รายรับ ${todayHouseIncome} บ. | รายจ่าย ${todayHouseExpense} บ. | คงเหลือ ${todayHouseIncome - todayHouseExpense} บ.
- ยอดสุทธิรวมตั้งแต่เปิดบัญชี: ${totalIncome - totalExpense} บ.

**คำสั่งสำคัญในการตอบกลับ**:
1. หากผู้ใช้ถามสรุปยอดวันนี้ (เช่น กำไรเท่าไหร่, ยอดขายเท่าไหร่) ให้ตอบยอดรวมสุทธิเป็นหลักก่อน แล้วค่อยแยกยอดร้านค้ากับครัวเรือน โดยใช้เครื่องหมาย \`|||\` คั่นกลางเพื่อให้แชทแสดงเป็น 2 บับเบิ้ล
ตัวอย่างการตอบ:
📊 **สรุปยอดสุทธิวันนี้**
🟢 รายรับรวม: X บาท
🔴 รายจ่ายรวม: X บาท
💰 กำไรสุทธิ: X บาท
|||
🏢 **ร้านค้า:** รับ X / จ่าย X / เหลือ X
🏠 **ครัวเรือน:** รับ X / จ่าย X / เหลือ X
...
{
  "reply": "ข้อความตอบกลับ (หากต้องการให้ขึ้นบับเบิ้ลใหม่ ให้คั่นด้วย |||)",
  "transactions": [
    {
...
3. การตอบกลับเมื่อจดบันทึกภาพรวม (ใช้ตารางเฉพาะตอนผู้ใช้ขอดูสรุปยอดรวมเท่านั้น):
   - **กรณีสรุปยอดรวมประจำวัน/ภาพรวม:**
     ...
     | **รวมสุทธิ** | **[ตัวเลข]** | **[ตัวเลข]** | **[ตัวเลข]** | **[กระแสเงินสดบวก/ติดลบ]** |
   - **กรณีแจ้งรายการที่เพิ่งจดบันทึก (ใหม่):**
     | วันที่ | รายการ | รายรับ | รายจ่าย | หมวดหมู่ | หมายเหตุ |
     | --- | --- | --- | --- | --- | --- |
