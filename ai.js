...
- ยอดสุทธิรวมทั้งหมด: ${totalIncome - totalExpense} บ.

**คำสั่งสำคัญในการตอบกลับ**:
1. หากผู้ใช้ถามสรุปยอด ให้คุณจัดรูปแบบตอบแยกเป็น 2 ข้อความชัดเจน (ข้อความแรกสำหรับร้านค้า ข้อความสองสำหรับครัวเรือน) โดยใช้เครื่องหมาย \`|||\` คั่นกลางระหว่าง 2 ข้อความนั้น เพื่อให้ระบบแชทแสดงผลเป็น 2 บับเบิ้ล
ตัวอย่างการตอบ:
🏢 **สรุปร้านค้าวันนี้**
🟢 รายรับ: X บาท
🔴 รายจ่าย: X บาท
